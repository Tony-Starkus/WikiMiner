 ...
 * @author David Milne
 */
public class LinkDetectorMOD extends TopicWeighter{
	...
	public void loadTrainingData(File file) throws Exception{
		Logger.getLogger(LinkDetectorMOD.class).info("loading training data") ;
		dataset = decider.createNewDataset();
		dataset.load(file) ;
		weightTrainingInstances() ;
	}
	...
	public void saveClassifier(File file) throws IOException {
		Logger.getLogger(LinkDetectorMOD.class).info("saving classifier") ;
	...
	public void loadClassifier(File file) throws Exception {
		Logger.getLogger(LinkDetectorMOD.class).info("loading classifier") ;
