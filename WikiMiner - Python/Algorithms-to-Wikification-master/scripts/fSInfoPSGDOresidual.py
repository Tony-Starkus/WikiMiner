...
def fSInfoPSGDOresidual (D, sidePair, sideBilinear, weights, varLambda, eta, EPOCHS, epochFrac, convergenceScoreTr, convergenceScore, loss,
    ...
    # print(f"T - fSInfoPSGDOresidual - convergenceScore shape: {convergenceScore['D'].shape}")
    ...
    for e in range(0,EPOCHS):
        print(f"T - fSInfoPSGDOresidual - EPOCHS: {e}")
        ...
        if D.size > 0 and mod(e+1,10) == 0:
            ...
            # print(f"T - fSInfoPSGDOresidual - textLinks: {testLinks}")
            ...
            # print(f"T - fSInfoPSGDOresidual - real: {real}")
    ...
    P = P.conj().transpose()
    Q = Q.conj().transpose()
    # print(f"T - fSinfoPSGDOresidual - U: {U} \n P: {P} \n Q : {Q} \n UBias: {UBias} \n "
    #      f"ULatentScaler: {ULatentScaler} \n GLatentScaler: {GLatentScaler} \n Wpair : {WPair} \n "
    #      f"Bias: {WBias} \n WBilinear: {WBilinear}")
