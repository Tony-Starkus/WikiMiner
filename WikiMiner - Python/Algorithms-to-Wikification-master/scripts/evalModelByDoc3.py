...
def evalModelByDoc3(predictions, truth, vp):
    # print(f"T - evalModelByDoc3 - predictions: {predictions} | truth: {truth} | vp type: {type(vp)}")
    # TESTE
    # seterr(all='print')
    ...
    for i in range(0, n):
        ...
        # print(f"T - evalModelByDoc3 - t: {t}")  # T - evalModelByDoc3 - t: [0 0 0 ... 0 0 0]
        t = t.reshape((1, t.shape[0]))

        auc, rmse = evalModel(p, t)
        # print(f"T - evalModelByDoc3 - auc: {auc}")  # T - evalModelByDoc3 - auc: nan
    ...
    # print(f"T - evalModelByDoc3 - mauc: {mauc}")
    ...
    if isnan(f1):
        f1 = 0
    # print(f"T - evalModelByDoc3 - auc : {auc} | rmse: {rmse} | f1: {f1} | prec: {prec} | rec: {rec}")
    # T - evalModelByDoc3 - auc : nan | rmse: 0.001201419903725316 | f1: 0 | prec: nan | rec: nan
